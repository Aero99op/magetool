...
export default function DataConvertClient() {
    ...
    return (
        <ToolLayout
            ...
            toolContent={
                <ToolContent
                    overview="Transform your data effortlessly with our Data Format Converter. Built for developers and data analysts, this tool converts between JSON, CSV, and XML formats instantly."
                    features={[
                        "Universal Interoperability: Convert between JSON, CSV, and XML.",
                        "Developer Friendly: Clean output formatting compatible with most data processing tools.",
                        "Instant Preview: Get your converted file immediately.",
                    ...
                    howTo={[
                        ...
                        { step: "Select Target", description: "Choose the output format you need." },
