...
export default function PDFCompressClient() {
    ...
    return (
        <ToolLayout
            ...
            toolContent={
                <ToolContent
                    overview="Reduce the file size of your PDF documents without sacrificing quality. Our intelligent PDF Compressor balances image optimization and font embedding to shrink files significantly."
                    features={[
