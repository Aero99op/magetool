...
export default function PDFProtectClient() {
    ...
    return (
        <ToolLayout
            ...
            toolContent={
                <ToolContent
                    overview="Secure your sensitive PDF documents with strong password protection. This tool encrypts your PDF file so it can only be opened by those who have the password."
                    features={[
                        ...
                        "Universal Compatibility: Protected PDFs open in all standard readers."
                    ]}
                    howTo={[
