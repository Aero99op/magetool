...
# Import routers
from routes import health, image, image_editor, video, audio, document, core, tools, distributed
...
app.include_router(distributed.router, prefix="/api/video", tags=["Distributed"])
